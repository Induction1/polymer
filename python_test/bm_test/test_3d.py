...
from bm.brownian_motion import calculate_f, from_bond_vectors_to_padded_bead_vectors, \
...
class ThreeDimTestCase(unittest.TestCase):
    ...
    def test_force_extension_of_dna(self):
        ...
        for i in range(steps):
            n_plus_3_beads = from_bond_vectors_to_padded_bead_vectors(bond_vectors)
